...
-  **CTFZone** — Solved blockchain challenge (SkyPieVault) via Solidity private storage slot enumeration using `eth_getStorageAt` + Python/web3.py
-  Pentest labs on **Kali Linux** (desktop) and **Kali NetHunter** (Android/arm64)
